(function () {
  ...
  // Best viewed in
  html +=
    '<div class="retro-sidebar-info" style="margin-top:12px;font-size:9px;color:#666;">';
  ...
  D.experience.forEach(function (e) {
    ...
    if (e.link) {
      html +=
        '<div class="retro-exp-link"><a href="' +
        esc(e.link.url) +
        '">&gt;&gt; ' +
        esc(e.link.label) +
        "</a></div>";
  ...
  html +=
    '<span class="spin-icon">&#9993;</span> Sign My Guestbook! <span class="spin-icon">&#9993;</span>';
  html += "</div>";
  ...
  html +=
    '<a class="retro-contact-btn primary" href="mailto:' + esc(D.email) + '">';
  html += '<span class="spin-icon">&#9993;</span> EMAIL ME!</a>';
  html +=
    '<a class="retro-contact-btn" href="' +
    esc(D.github) +
  ...
  html +=
    '<div class="retro-footer-netscape">Best viewed in Netscape Navigator 4.0 at 800x600</div>';
  html += "</div>";
